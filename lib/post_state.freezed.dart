...
abstract class $PostStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int page, List<Post>? posts, bool isLoadMoreError, bool isLoadMoreDone});
}
...
class _$_PostState extends _PostState {
  ...
  @override
  String toString() {
    return 'PostState(page: $page, posts: $posts, isLoadMoreError: $isLoadMoreError, isLoadMoreDone: $isLoadMoreDone)';
  }
